...
const LpShoppingCart = ({ isOpen, onClose, cartItems, cartSize, renderCartSize, removeFromCart, WebSocketService }) => {
                    ...
                    <div className="bg-white p-3 rounded-[25px] shadow-lg flex flex-col w-[75vw] h-[75vh]">
                        ...
                        <div className='flex flex-col items-center justify-end'>
                            ...
                            <button className='font-bold leading-10 rounded-3xl mx-auto px-3 bg-light-secondary text-white mb-3 mt-5'>
                                <div className='flex items-center gap-1' onClick={sendOrder}> {/* Change the onClick for submitting order */}
