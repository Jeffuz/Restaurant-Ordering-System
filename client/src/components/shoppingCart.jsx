        ...
        <div className="bg-white h-screen flex flex-col justify-between">
                ...
                <div className="grid grid-flow-row auto-row-max gap-y-4 m-4">
                    {cartItems.map((cartItem, index) => (
                        <ShoppingCartCard
                            ...
                            ifChangeCounter={(newCount) =>
                                changeCounter(index, newCount)
                            }
                        />
                    ))}
                </div>
            ...
            <div className="">
                ...
                <div className="p-4 bg-gray-200 flex gap-4 justify-between ">
                    <button
                        className="bg-white text-gray px-6 py-6 rounded-md w-[25%] hover:bg-gray-50 transition ease-in-out"
                        onClick={() => openModal()}
                    >
                        Order Status
                    </button>
                    <button className="bg-white text-gray px-6 py-6 rounded-md w-[25%] hover:bg-gray-50 transition ease-in-out">
                        Help
                    </button>
                    <button
                        className="bg-white text-gray px-6 py-6 rounded-md w-[25%] hover:bg-gray-50 transition ease-in-out"
