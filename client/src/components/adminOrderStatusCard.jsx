...
const AdminOrderStatusCard = ({ item }) => {
    return (
        <div key={item.itemStatus} className='bg-gray-100 p-4 mb-4 flex items-center justify-between rounded-lg shadow-md'>
            <img src={item.itemImage} alt={item.itemName} className='h-16 object-cover' />
            <div className="flex flex-col">
                <div className="font-semibold text-xl leading-none">{item.itemName}</div>
                <div className="font-bold text-xl leading-none">Order #{item.itemOrderNum}</div>
