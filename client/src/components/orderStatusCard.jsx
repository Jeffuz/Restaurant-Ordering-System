    ...
    return (
        <div className="bg-gray-100 p-4 mb-4 flex items-center justify-between rounded-lg shadow-md">
            ...
            <div className="flex flex-col">
                ...
                <div className="font-semibold text-xl leading-none">Order #{itemOrderNum}</div>
                <div className="text-gray-500 font-normal text-sm leading-tight">Quantity: {itemCount}</div>
            </div>
