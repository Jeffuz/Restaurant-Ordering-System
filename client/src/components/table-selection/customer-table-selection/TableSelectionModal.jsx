  ...
  return (
    <div className="fixed inset-0 flex items-center justify-center bg-black bg-opacity-50">
      ...
      <div className="bg-white p-8 rounded-3xl">
        ...
        <h3 className="text-2xl font-semibold mb-4">{`Table ${table.number} Details`}</h3>
        ...
        {table.status === 'available' && (
          <>
            <button
              className="bg-[#D9D9D9] text-black py-2 px-4 rounded-md mr-2"
            ...
            <button
              className="bg-[#D9D9D9] text-black py-2 px-4 rounded-md"
