...
const WebSocketService = {
    ...
    connect(hostname = "127.0.0.1", port = "8080", isMaster = false) {
        return new Promise((resolve, reject) => {
            ...
            function connectToServer(hostname, port) {
                return new Promise((resolve, reject) => {
                    ...
                    socket.addEventListener("open", (e) => {
                        console.log(
                            "WebSocket connection is open (connected)."
                        );
                    });
                    ...
                    socket.addEventListener("message", (e) => {
                        ...
                        switch (action) {
                            ...
                            case "ORDERPLACED":
                                ...
                                allOrders = payload.allOrders;
                                WebSocketService.waitingOrders =
                                    payload.waitingOrders;
                                WebSocketService.workingOrders =
                                    payload.workingOrders;
                                WebSocketService.finishedOrders =
                                    payload.finishedOrders;
                            ...
                            default:
                                console.log(
                                    "ERROR: NO METHOD DETECTED IN MESSAGE"
                                );
            ...
            connectToServer(hostname, port).then(
                ([socket, id, menu, allOrders]) => {
